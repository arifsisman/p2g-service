...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws DatabaseException, InvalidArgumentException, InvalidUpdateException {
        ...
        User u1 = userService.createUser("1", "1@gmail.com", "TEST 1", "0");
        User u2 = userService.createUser("2", "2@gmail.com", "TEST 2", "0");
        User u3 = userService.createUser("3", "3@gmail.com", "TEST 3", "0");
        User u4 = userService.createUser("4", "4@gmail.com", "TEST 4", "0");
        User u5 = userService.createUser("5", "5@gmail.com", "TEST 5", "0");
        User u6 = userService.createUser("6", "6@gmail.com", "TEST 6", "0");
        User u7 = userService.createUser("7", "7@gmail.com", "TEST 7", "0");
        User u8 = userService.createUser("8", "8@gmail.com", "TEST 8", "0");
        ...
        Room testRoom4 = roomService.createRoom(u3.getId(), "Test Room 4", "0");
        Room testRoom5 = roomService.createRoom(u4.getId(), "Test Room 5", "0");
        Room testRoom6 = roomService.createRoom(u5.getId(), "Test Room 6", "0");
        Room testRoom8 = roomService.createRoom(u6.getId(), "Test Room 8", "0");
        Room testRoom7 = roomService.createRoom(u7.getId(), "Test Room 7", "0");
        Room testRoom9 = roomService.createRoom(u8.getId(), "Test Room 9", "0");
