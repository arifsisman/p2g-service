...
//        User arifTest = userService.createUser("4zmop7n9batjv78uvzy6u44um", "mustafaarifsismann@gmail.com", "Mustafa", "0");
        User emre = userService.createUser("UNDEFINED", "emre@mail.com", "Emre Sen", "0");

        Room testRoom1 = roomService.createRoom(arif.getId(), "Test Room1", "0");
        Room testRoom2 = roomService.createRoom(emre.getId(), "Test Room2", "0");
