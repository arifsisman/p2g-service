...
import vip.yazilim.p2g.web.service.ICrudService;
...
public abstract class ACrudServiceImpl<E extends Serializable, ID> implements ICrudService<E, ID> {
     ...
     * @throws DatabaseException an exception occurred during execution of query
     */
    private E save(E entity) throws DatabaseException {
        try {
            ...
            String errorMessage = String.format("An error occurred while saving %s", entity);
    ...
    public boolean delete(E entity) throws DatabaseException {
        try {
            ...
            String errorMessage = String.format("An error occurred while deleting %s", entity);
            throw new DatabaseException(errorMessage, exception);
        }
    }
