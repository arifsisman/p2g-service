...
public interface IUserService extends ICrudService<User, String> {
    ...
    Optional<UserModel> getUserModelByUserUuid(String userUuid) throws DatabaseException, InvalidArgumentException;
    ...
    User setSpotifyInfo(com.wrapper.spotify.model_objects.specification.User spotifyUser, User user) throws DatabaseException, InvalidArgumentException;
